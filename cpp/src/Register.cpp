                            ...
                            const NanoflannPointsContainer<double> &kdTreePts)
{
    ...
    // The parameter regResult_ is replaced with the current pose estimate.
    ...
    seedConstVel_ = utils::hom2rpyxyz(
                        utils::homogeneous(regResult_(0), regResult_(1),
                                regResult_(2), regResult_(3),
                                regResult_(4), regResult_(5)) *
                        (utils::homogeneous(prevResult_(0), prevResult_(1),
