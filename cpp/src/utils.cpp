...
namespace utils {
    ...
    void writeResults(const ConfigParser &config,
                      const std::vector<std::vector<double> > &poseEstimates,
                      const std::string &outputFileName, double avgTimePerScan)
    {
        ...
        outputConfigFile << "% computation finised at : " << std::ctime(&end_time)
                        ...
                        << config.getConvergenceTol()                   
                        << ";" << std::endl
                        << "maxSensorRange         = " 
                        << config.getMaxSensorRange()                   
                        << ";" << " % [m]" << std::endl
                        << "minSensorRange         = " 
                        << config.getMinSensorRange()                   
                        << ";" << " % [m]" << std::endl
                        << "outputFileName         = " 
